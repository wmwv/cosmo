...
// WCDM stores the key information needed for a given cosmology
//
...
//
// distmod : [mag]
func (cos WCDM) DistanceModulus(z float64) (distmod float64) {
...
//
// distance : Mpc
func (cos WCDM) LuminosityDistance(z float64) (distance float64) {
...
//
// distance : Mpc/rad
func (cos WCDM) AngularDiameterDistance(z float64) (distance float64) {
...
//
// distance : Mpc
func (cos WCDM) ComovingTransverseDistance(z float64) (distance float64) {
...
//
// distance : Mpc
func (cos WCDM) ComovingTransverseDistanceZ1Z2(z1, z2 float64) (distance float64) {
...
//
func (cos WCDM) ComovingDistance(z float64) (distance float64) {
...
func (cos WCDM) ComovingDistanceZ1Z2Elliptic(z1, z2 float64) (distance float64) {
...
func (cos WCDM) ComovingDistanceZ1Z2Integrate(z1, z2 float64) (distance float64) {
...
func (cos WCDM) ComovingDistanceZ1Z2(z1, z2 float64) (distance float64) {
	switch {
...
func (cos WCDM) ComovingDistanceOM(z float64) (distance float64) {
...
func (cos WCDM) ComovingDistanceOMZ1Z2(z1, z2 float64) (distance float64) {
...
//
// z : redshift
func (cos WCDM) LookbackTime(z float64) (time float64) {
	switch {
...
//
// z : redshift
func (cos WCDM) LookbackTimeIntegrate(z float64) (time float64) {
	n := 1000 // Integration will be n-point Gaussian quadrature
...
//
// z : redshift
func (cos WCDM) LookbackTimeOL(z float64) (time float64) {
...
//
// z : redshift
func (cos WCDM) LookbackTimeOM(z float64) (time float64) {
...
//
// z : redshift
func (cos WCDM) Age(z float64) (time float64) {
	switch {
...
func (cos WCDM) AgeFlatLCDM(z float64) (time float64) {
...
func (cos WCDM) AgeIntegrate(z float64) (time float64) {
	n := 1000 // Integration will be n-point Gaussian quadrature
...
// z : redshift
func (cos WCDM) AgeOL(z float64) (time float64) {
...
func (cos WCDM) Einv(z float64) (invEz float64) {
...
func (cos WCDM) Evec(z []float64) (ez []float64) {
	for _, z := range z {
